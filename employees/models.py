...
class Salary(models.Model):
    ...
    salary_proportion = models.DecimalField(max_digits=3, decimal_places=2, verbose_name='工资比例')
...
class RegularMeeting(models.Model):
    # 例会标题，例会参与人员，例会时间，例会主要内容（富文本格式）和附件就行了
    title = models.CharField(max_length=50, verbose_name="例会标题")
    specker = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="报告人")  # Employee
